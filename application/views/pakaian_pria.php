<div class="container-fluid">
    ...
    <div class="carousel-inner">
        ...
        <img src="<?php echo base_url('assets/img/benner1.jpeg') ?>" height="500" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
        <img src="<?php echo base_url('assets/img/benner2.jpg') ?>" height="500" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
        <img src="<?php echo base_url('assets/img/benner3.jpg') ?>" height="500" class="d-block w-100" alt="...">
        </div>
    </div>
