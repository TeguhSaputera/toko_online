<div class="container-fluid">
    ...
    <div class="carousel-inner">
        ...
        <img src="<?php echo base_url('assets/img/benner1.jpeg') ?>"  class="d-block w-100" height="500" alt="...">
        </div>
        <div class="carousel-item">
        <img src="<?php echo base_url('assets/img/benner2.jpg') ?>" class="d-block w-100" height="500" alt="...">
        </div>
        <div class="carousel-item">
        <img src="<?php echo base_url('assets/img/benner3.jpg') ?>" class="d-block w-100" height="500" alt="...">
        </div>
    </div>
